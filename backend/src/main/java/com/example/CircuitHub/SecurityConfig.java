    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/items/**").hasAnyRole("ADMIN", "LAB-ASSISTANT")
                ...
                .requestMatchers("/api/requests/*/lab-approve").hasAnyRole("ADMIN", "LAB-ASSISTANT")
                .requestMatchers("/api/requests/pending-lab").hasAnyRole("ADMIN", "LAB-ASSISTANT")
                
                // Authenticated users
                .requestMatchers("/api/requests/**").authenticated()
                .requestMatchers("/api/users/**").authenticated()
                .requestMatchers("/api/maintenance/**").hasAnyRole("ADMIN", "LAB-ASSISTANT")
